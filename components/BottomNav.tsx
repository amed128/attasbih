...
export function BottomNav() {
  ...
  return (
    <nav role="navigation" aria-label="Navigation principale" className="fixed bottom-0 left-0 right-0 z-20 border-t border-[var(--border)] bg-[var(--background)]" style={{ paddingBottom: "var(--android-nav-inset, 0px)" }}>
