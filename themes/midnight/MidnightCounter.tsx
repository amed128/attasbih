    ...
    {showSpeedPopup && (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-6">
        <div className="w-full max-w-sm rounded-2xl border p-4"
          style={{ background: "rgba(7,16,32,0.98)", borderColor: "rgba(214,232,255,0.18)" }}>
          <h2 className="text-base font-semibold" style={{ color: "#D6E8FF" }}>{t("counter.speedModal.title")}</h2>
          <p className="mt-2 text-sm" style={{ color: "#6A82A8" }}>{t("counter.speedModal.body")}</p>
          <input
          ...
          <div className="mt-4 flex gap-2">
            <button type="button" onClick={() => setShowSpeedPopup(false)}
              ...
              style={{ borderColor: "rgba(214,232,255,0.18)", color: "#6A82A8", background: "transparent" }}>
            ...
            <button type="button" onClick={() => {
              ...
              className="flex-1 rounded-xl border px-3 py-2 text-sm font-semibold"
              style={{ borderColor: "rgba(214,232,255,0.4)", background: "rgba(214,232,255,0.12)", color: "#D6E8FF" }}>
